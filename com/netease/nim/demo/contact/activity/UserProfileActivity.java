...
import com.netease.nim.demo.location.activity.BNDemoMainActivity;
...
public class UserProfileActivity extends UI {
    ...
    private void findViews() {
        ...
        navi=findView(R.id.begin_navigation);
        ...
        navi.setOnClickListener(onClickListener);
    ...
    private View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (v == addFriendBtn) {
                ...
                Intent intent=new Intent();
                intent.putExtra("extra", account);
                intent.setClass(UserProfileActivity.this, BNDemoMainActivity.class);
