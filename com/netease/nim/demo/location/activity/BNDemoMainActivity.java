...
public class BNDemoMainActivity extends Activity {
    ...
    public  void routeplanToNavi( String Acount) {
        ...
        /*User me=MapFragment.getUser(LoginActivity.getUseraccount());
        User friend=MapFragment.getUser(Acount);

        Log.i("longitude",LoginActivity.getUseraccount()+"dfsa");*/
        sNode = new BNRoutePlanNode(103.998588, 30.557824, "自己", null, BNRoutePlanNode.CoordinateType.WGS84);
        eNode= new BNRoutePlanNode(104.398588,30.657824, "好友", null, BNRoutePlanNode.CoordinateType.WGS84);
